...
export default async function Home() {
  ...
  return (
          <div className="h-full flex flex-col items-center border border-red-600 rounded text-lg">
            <div className="h-full w-1/2 border border-zinc-700 divide-y divide-zinc-200 px-8">
              <div>
